...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "abdikhairul71@gmail.com",
    href: "mailto:abdikhairul71@gmail",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+62 (8) 9614407474",
    href: "tel:+6289614407474",
  },
  {
    icon: MapPin,
    label: "Location",
          ...
          <div className="glass p-4 sm:p-6 md:p-8 rounded-3xl border border-primary/30 animate-fade-in animation-delay-300">
            <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
              ...
              {submitStatus.type && (
                ...
                >
                  {submitStatus.type === "success" ? (
                    <CheckCircle className="w-5 h-5 flex-0" />
                  ) : (
                    <AlertCircle className="w-5 h-5 flex-0" />
                  )}
