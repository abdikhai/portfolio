...
const tagIconMap = {
  ...
  "tailwind css 4": Palette,
  "alpine.js": Braces,
  "next.js": Globe,
  apexcharts: BarChart2,
...
const tagColorMap = {
  laravel:
    "hover:text-[#FF2D20] hover:border-[#FF2D20]/40 hover:bg-[#FF2D20]/5",
  "laravel 12":
    "hover:text-[#FF2D20] hover:border-[#FF2D20]/40 hover:bg-[#FF2D20]/5",
  php: "hover:text-[#8892BF] hover:border-[#8892BF]/40 hover:bg-[#8892BF]/5",
  "php 8.2":
    "hover:text-[#8892BF] hover:border-[#8892BF]/40 hover:bg-[#8892BF]/5",
  "alpine.js":
    "hover:text-[#77C1D2] hover:border-[#77C1D2]/40 hover:bg-[#77C1D2]/5",
  apexcharts:
    "hover:text-[#00E396] hover:border-[#00E396]/40 hover:bg-[#00E396]/5",
  gis: "hover:text-[#818CF8] hover:border-[#818CF8]/40 hover:bg-[#818CF8]/5",
  "leaflet.js":
    "hover:text-[#B5E853] hover:border-[#B5E853]/40 hover:bg-[#B5E853]/5",
  ...
  sqlalchemy:
    "hover:text-[#D7191C] hover:border-[#D7191C]/40 hover:bg-[#D7191C]/5",
  openpyxl:
    "hover:text-[#107C41] hover:border-[#107C41]/40 hover:bg-[#107C41]/5",
  streamlit:
    "hover:text-[#FF4B4B] hover:border-[#FF4B4B]/40 hover:bg-[#FF4B4B]/5",
  eda: "hover:text-[#f5a623] hover:border-[#f5a623]/40 hover:bg-[#f5a623]/5",
  "data visualization":
    "hover:text-[#3b82f6] hover:border-[#3b82f6]/40 hover:bg-[#3b82f6]/5",
  opencv: "hover:text-[#5C3EE8] hover:border-[#5C3EE8]/40 hover:bg-[#5C3EE8]/5",
  javascript:
    "hover:text-[#F7DF1E] hover:border-[#F7DF1E]/40 hover:bg-[#F7DF1E]/5",
  ...
  bootstrap:
    "hover:text-[#7952B3] hover:border-[#7952B3]/40 hover:bg-[#7952B3]/5",
  "tailwind css":
    "hover:text-[#06B6D4] hover:border-[#06B6D4]/40 hover:bg-[#06B6D4]/5",
  "next.js":
    "hover:text-[#ffffff] hover:border-[#ffffff]/40 hover:bg-[#ffffff]/5",
  android:
    "hover:text-[#3DDC84] hover:border-[#3DDC84]/40 hover:bg-[#3DDC84]/5",
  tensorflow:
    "hover:text-[#FF6F00] hover:border-[#FF6F00]/40 hover:bg-[#FF6F00]/5",
  "google cloud":
    "hover:text-[#4285F4] hover:border-[#4285F4]/40 hover:bg-[#4285F4]/5",
  "machine learning":
    "hover:text-[#EC4899] hover:border-[#EC4899]/40 hover:bg-[#EC4899]/5",
